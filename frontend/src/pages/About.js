...
const About = () => {
  const TEAM_IMG = "https://cdn-icons-png.freepik.com/256/9055/9055398.png?semt=ais_white_label";
  return (
    <Box sx={{ mt: 2 }}>
      {/* Hero Section */}
      <Box sx={{ py: { xs: 4, md: 8 } }}>
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center" minHeight={{ md: "50vh" }}>
            <Grid item xs={12} md={6}>
              <Typography variant="h3" fontWeight={800} color="primary" gutterBottom>
                Về Flower Shop
              </Typography>
              <Typography variant="h6" color="text.primary" sx={{ mb: 2 }}>
                Chúng tôi là cửa hàng hoa tươi hàng đầu, mang đến những bó hoa tuyệt đẹp
                cho mọi dịp đặc biệt trong cuộc sống của bạn.
              </Typography>
              <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                Với hơn 10 năm kinh nghiệm trong ngành hoa tươi, chúng tôi cam kết cung cấp
                những sản phẩm chất lượng cao nhất và dịch vụ tận tâm cho khách hàng.
              </Typography>
              <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
                <Button component={RouterLink} to="/products" variant="contained" size="large">
                  Xem Sản Phẩm
                </Button>
                <Button href="mailto:support@flowershop.com" variant="outlined" size="large">
                  Liên Hệ Ngay
                </Button>
              </Box>
            </Grid>
        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <ValueCard
                icon={<FavoriteIcon fontSize="large" sx={{ color: "error.main" }} />}
            ...
            <Grid item xs={12} md={4}>
              <ValueCard
                icon={<LocalShippingIcon fontSize="large" sx={{ color: "success.main" }} />}
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography sx={{ mb: 2 }}>
                Flower Shop được thành lập vào năm 2014 bởi một nhóm những người yêu thích hoa và muốn
                mang vẻ đẹp của thiên nhiên đến gần hơn với cuộc sống hàng ngày.
              </Typography>
              <Typography sx={{ mb: 2 }}>
                Từ một cửa hàng nhỏ, chúng tôi đã phát triển thành một trong những thương hiệu hoa tươi
                uy tín, phục vụ hàng nghìn khách hàng trên toàn quốc.
              </Typography>
              <Typography sx={{ mb: 3 }}>
                Chúng tôi tự hào là đối tác tin cậy trong những dịp quan trọng như sinh nhật, kỷ niệm,
                đám cưới, và nhiều sự kiện đặc biệt khác.
              </Typography>
        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={3} justifyContent="center">
            {[
              ...
              <Grid key={idx} item xs={12} sm={6} md={3} lg={2.4} sx={{ display: "flex", justifyContent: "center" }}>
                <Card elevation={2} sx={{ width: "100%", maxWidth: 220 }}>
                  <Box sx={{ p: 0 }}>
                    <ImgWithFallback src={m.img} alt={m.name} height={250} rounded={false} />
                  </Box>
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="h6" sx={{ opacity: 0.9, mb: 3 }}>
              Hãy để chúng tôi giúp bạn thể hiện tình cảm qua những bó hoa tuyệt đẹp
            </Typography>
            <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
              <Button component={RouterLink} to="/products" variant="contained" color="secondary" size="large">
                Mua Ngay
              </Button>
              <Button href="tel:+84123456789" variant="outlined" color="inherit" size="large">
                Liên Hệ Tư Vấn
              </Button>
            </Box>
          </Box>
