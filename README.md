...
```
> Ghi chú: `CORS_ORIGIN` không bắt buộc nhưng nên đặt khi triển khai production. Nếu dùng hosting MySQL, cập nhật các biến kết nối tương ứng.

#### Frontend (`frontend/.env`)
```env
REACT_APP_API_URL=http://localhost:5000/api
REACT_APP_IMGBB_KEY=your_imgbb_api_key
```
- `REACT_APP_IMGBB_KEY` bắt buộc cho chức năng upload ảnh sản phẩm/shop.
